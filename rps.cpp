// lastFourBits.cpp : Defines the entry point for the console application.

//Don't include this if you're not using Visual Studio.
#include "stdafx.h"
...
unsigned __int64 x = 1234567891, y = 3624360691, z = 5212886291;
unsigned __int64 counts[15] = {};
unsigned __int64 t;
...
int main()
{
	...
	std::cout << "player 1 score: " << (counts[1] + counts[6] + counts[8]) << std::endl;
	std::cout << "player 2 score: " << (counts[2] + counts[4] + counts[9]) << std::endl;
	std::cout << "total games: " << (counts[1] + counts[6] + counts[8] + counts[2] + counts[4] + counts[9] + counts[0] + counts[5] + counts[10]) << std::endl;
	return 0;
}
